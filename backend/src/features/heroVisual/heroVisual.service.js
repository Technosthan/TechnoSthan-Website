...
const FALLBACK_PUBLIC_HERO = {
  id: "fallback-public-hero",
  mainImageUrl: null,
  mainImageAlt: "Technosthan enterprise technology visual",
  heroHeadingLines: DEFAULT_HERO_HEADING_LINES,
  ...
  features: [
    {
      ...
      settingId: "fallback-public-hero",
      title: "Enterprise",
      iconKey: "FiBriefcase",
      iconImageUrl: null,
...
export const getPublicHeroVisual = async () => {
  try {
    ...
    return setting ? mapSetting(setting) : FALLBACK_PUBLIC_HERO;
  } catch (error) {
    if (isDatabaseUnavailableError(error)) {
      console.warn(
        "[heroVisual] Database unavailable, using fallback public hero content."
      );
      return FALLBACK_PUBLIC_HERO;
    }
