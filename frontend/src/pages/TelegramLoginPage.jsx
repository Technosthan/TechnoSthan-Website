...
const TelegramLoginPage = () => {
  ...
  const handleSendOtp = async () => {
    ...
    setError("");
    try {
      await sendLoginOtp({ phone, method: "telegram" });
      setStep("otp");
    } catch (err) {
  ...
  const handleVerifyOtp = async () => {
    ...
    setError("");
    try {
      const response = await verifyLoginOtp({ phone, otp, method: "telegram" });
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${theme === "dark" ? "bg-gray-700 border-gray-600 text-white" : "bg-white border-gray-300"}`}
