...
const routePositionOptions = {
  ...
  "/about": [
    ...
    { value: "intro", label: "Below About Intro" },
    { value: "values", label: "Below Values Section" },
    { value: "footer", label: "Before Footer" },
  ],
  "/what-we-do": [
    { value: "hero", label: "Below Hero" },
    { value: "intro", label: "Below Intro" },
    { value: "footer", label: "Before Footer" },
  ],
  "/services": [
    { value: "hero", label: "Below Hero" },
    { value: "services", label: "Below Services Grid" },
    { value: "footer", label: "Before Footer" },
  ],
  "/infrastructure-development": [
    { value: "hero", label: "Below Hero" },
    { value: "timeline", label: "Below Delivery Model" },
    { value: "footer", label: "Before Footer" },
  ],
  "/real-estate-development": [
    { value: "hero", label: "Below Hero" },
    { value: "categories", label: "Below Categories" },
    { value: "footer", label: "Before Footer" },
  ],
  "/projects": [
    { value: "hero", label: "Below Hero" },
    { value: "projects", label: "Below Projects Grid" },
    { value: "footer", label: "Before Footer" },
  ],
  "/partnerships": [
    { value: "hero", label: "Below Hero" },
    { value: "partnerships", label: "Below Partnerships" },
    { value: "footer", label: "Before Footer" },
  ],
  "/government-and-institutional-projects": [
    { value: "hero", label: "Below Hero" },
    { value: "government", label: "Below Institutional Content" },
    { value: "footer", label: "Before Footer" },
  ],
  "/sustainability": [
    { value: "hero", label: "Below Hero" },
    { value: "sustainability", label: "Below Sustainability Content" },
    { value: "footer", label: "Before Footer" },
  ],
  "/investors": [
    { value: "hero", label: "Below Hero" },
    { value: "investors", label: "Below Investor Content" },
    { value: "footer", label: "Before Footer" },
  ],
  "/news-and-insights": [
    { value: "hero", label: "Below Hero" },
    { value: "insights", label: "Below Insights Listing" },
    { value: "footer", label: "Before Footer" },
  ],
  "/contact": [
  ...
  "/privacy-policy": [
    { value: "hero", label: "Below Hero" },
    { value: "content", label: "Below Policy Content" },
    { value: "footer", label: "Before Footer" },
  ],
  "/terms-and-conditions": [
    { value: "hero", label: "Below Hero" },
    { value: "content", label: "Below Terms Content" },
    { value: "footer", label: "Before Footer" },
  ],
  "/disclaimer": [
    { value: "hero", label: "Below Hero" },
    { value: "content", label: "Below Disclaimer Content" },
    { value: "footer", label: "Before Footer" },
  ],
};
...
const PageContentManager = () => {
  ...
  return (
    <AdminLayout
  // title="TechnoSthan Page Content"
  // subtitle="Create reusable sections for TechnoSthan routes without replacing the existing site content."
    >
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <h2 className="text-2xl font-semibold text-white" >
                Add content blocks for TechnoSthan routes like /, /projects, /contact, or future pages
              </h2>
            </div>
