...
export const approveUploads = (uploadedBy) => api.post(`/admin/approve/${uploadedBy}`);
export const rejectUploads = (uploadedBy, reason) => api.post(`/admin/reject/${uploadedBy}`, { reason });
