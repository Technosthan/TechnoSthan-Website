...
const DashboardPage = () => {
  ...
  const visibleCards = appSettings?.dashboardSettings?.visibleCards || [
    "stats",
    "users",
    "content",
    "quiz",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    },
                    {
                      icon: BarChart3,
                      title: "My Dashboard",
                      desc: "View your learning stats and progress",
                      path: "/dashboard",
